...
public class LoanDisbursalController {
	...
	public @ResponseBody List<LoanDisbursalEntity> fetchAllLoanRequests(@RequestParam("filter") String filter) {
		logger.info("In controller fetching requests  ");
		return service.fetchloans(filter);
